    ...
    public partial class FrmOperacionesRealizadas : Form
    {
        ...
        private List<OperacionRealizada> ListarOperacionesRealizadas()
        {
            ...
            foreach (var operacion in operaciones)
            {
                ...
                else if (operacion is DepositoConCuenta)
                {
                ...
                else if (operacion is DepositoSinCuenta)
                {
        ...
        private SLDocument CrearDocumentoExcel(DataTable tablaDatos)
        {
            ...
            documento.SetCellValue("B3", $"LISTA DE OPERACIONES DEL {DtpInicio.Value.Date:dd/MM/yyyy} AL {DtpFin.Value.Date:dd/MM/yyyy}");
