...
{
    public partial class FrmListaRetiros : Form
    {
        public FrmListaRetiros()
        {
            InitializeComponent();
        }
        ...
        private SLDocument CrearDocumentoExcel(DataTable tablaDatos)
        {
            ...
            documento.SetCellValue("B3", $"LISTA DE RETIROS DEL {DtpInicio.Value.Date:dd/MM/yyyy} AL {DtpFin.Value.Date:dd/MM/yyyy}");
